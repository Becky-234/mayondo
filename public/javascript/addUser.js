...
//     const validators = {
//         name: (value) => value && value.trim().length >= 2 && value.trim().length <= 100,
//         email: (value) => {
...
//         },
//         nin: (value) => value && /^[a-zA-Z0-9]{8,20}$/.test(value),
//         address: (value) => value && value.trim().length >= 5 && value.trim().length <= 200,
...
//     // Validate single field - FORCE validation (always show errors)
...
//             return false;
//         } else {
//             // Only show success if the field has been interacted with or is valid
//             if (forceShowError || field.classList.contains('is-invalid') || value) {
...
//     // Validate entire form - FORCE show all errors
//     function validateForm(forceShowErrors = false) {
//         let isValid = true;

//         Object.keys(fields).forEach(fieldName => {
//             if (!validateField(fieldName, forceShowErrors)) {
//                 isValid = false;
//             }
//         });
...
//     // NEW: Mark fields as touched when user interacts with them
...
//             // Validate on input if field was already invalid
...
//             // NEW: Also validate when user focuses out (for better UX)
...
//     // Form submit event - THE KEY FIX: Force show all errors on submit
//     form.addEventListener('submit', function (e) {
//         console.log('Form submit triggered');

//         // Force show ALL errors when form is submitted
//         if (!validateForm(true)) { // Pass true to force show errors
//             e.preventDefault(); // Only prevent if form is invalid
